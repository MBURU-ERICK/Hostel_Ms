...
<head>
    ...
    <title>Service Requests Management - HostelHub Admin</title>
        ...
        <div class="flex-1 p-8">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Service Requests Management</h1>
                        <p class="text-gray-600 mt-2">Manage all maintenance service requests</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="p-6">
                            ...
                            <table class="w-full">
                                <thead>
                                    <tr class="border-b border-gray-200">
                                        <th class="text-left py-3 px-4 text-sm font-medium text-gray-600">Request</th>
                                        <th class="text-left py-3 px-4 text-sm font-medium text-gray-600">Student</th>
                                        <th class="text-left py-3 px-4 text-sm font-medium text-gray-600">Service Provider</th>
                                ...
                                <tbody>
                                    @foreach($serviceRequests as $request)
                                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                                            ...
                                            <td class="py-4 px-4">
                                                <p class="text-sm text-gray-900">{{ $request->student->name }}</p>
                                                <p class="text-xs text-gray-500">{{ $request->student->email }}</p>
                                            </td>
                                            <td class="py-4 px-4">
                                                @if($request->serviceProvider)
                                                    <p class="text-sm text-gray-900">{{ $request->serviceProvider->company_name }}</p>
                                                @else
                                                    <span class="text-xs text-gray-500">Not assigned</span>
                                                @endif
                                            </td>
                                            <td class="py-4 px-4">
                                                <p class="text-sm text-gray-900">{{ $request->hostel->name }}</p>
                                                <p class="text-xs text-gray-500">Room {{ $request->room_number }}</p>
                                            </td>
                                            <td class="py-4 px-4">
                                                <span class="text-xs px-2 py-1 rounded-full
                                                    {{ $request->urgency_level == 'low' ? 'bg-green-100 text-green-800' : '' }}
                    ...
                    @else
                        <p class="text-gray-500 text-center py-8">No service requests found.</p>
                    @endif
                </div>
            </div>
        </div>
